...
data = read.csv("/Users/islekbro/Desktop/genomize_makale/2_evidence_codes/evidence_outputs/6_plot_total_inputs/evidence_total.csv", sep="\t" , header=TRUE)
...
library(ggplot2)
library(geomtextpath)
data = read.csv("/Users/islekbro/Desktop/genomize_makale/2_evidence_codes/evidence_outputs/6_plot_total_inputs/common_total.csv", sep="\t" , header=TRUE)
CS_data <- data %>%
  filter(platform=="CS")
...
ggsave(filename = "/Users/islekbro/Desktop/genomize_makale/2_evidence_codes/evidence_outputs/6_plot_total_outputs/CS.pdf", 
       plot = first,
       units = "in", 
       width = 20,
       height= 9,
...
ggsave(filename = "/Users/islekbro/Desktop/genomize_makale/2_evidence_codes/evidence_outputs/6_plot_total_outputs/CF.pdf", 
       plot = second,
       units = "in", 
       width = 20,
       height= 9,
