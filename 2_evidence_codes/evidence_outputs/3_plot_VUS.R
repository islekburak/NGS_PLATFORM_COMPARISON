...
data = read.csv("/Users/islekbro/Desktop/genomize_makale/2_evidence_codes/evidence_outputs/3_plot_VUS_inputs/evidence_VUS.csv", sep="\t" , header=TRUE)
...
library(ggplot2)
library(geomtextpath)
data = read.csv("/Users/islekbro/Desktop/genomize_makale/2_evidence_codes/evidence_outputs/3_plot_VUS_inputs/common_VUS.csv", sep="\t" , header=TRUE)
CS_data <- data %>%
  filter(platform=="CS_VUS")

CF_data <- data %>%
  filter(platform=="CF_VUS")
...
ggsave(filename = "/Users/islekbro/Desktop/genomize_makale/2_evidence_codes/evidence_outputs/3_plot_VUS_outputs/VUS_CS.pdf", 
       plot = first,
       units = "in", 
       width = 20,
       height= 9,
...
ggsave(filename = "/Users/islekbro/Desktop/genomize_makale/2_evidence_codes/evidence_outputs/3_plot_VUS_outputs/VUS_CF.pdf", 
       plot = second,
       units = "in", 
       width = 20,
       height= 9,
