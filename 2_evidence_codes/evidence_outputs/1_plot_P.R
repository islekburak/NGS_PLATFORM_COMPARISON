...
data = read.csv("/Users/islekbro/Desktop/genomize_makale/2_evidence_codes/evidence_outputs/1_plot_P_inputs/evidence_P.csv", sep="\t" , header=TRUE)
...
library(ggplot2)
library(geomtextpath)
data = read.csv("/Users/islekbro/Desktop/genomize_makale/2_evidence_codes/evidence_outputs/1_plot_P_inputs/common_P.csv", sep="\t" , header=TRUE)
CS_data <- data %>%
  filter(platform=="CS_P")

CF_data <- data %>%
  filter(platform=="CF_P")
...
ggsave(filename = "/Users/islekbro/Desktop/genomize_makale/2_evidence_codes/evidence_outputs/1_plot_P_outputs/P_CS.pdf", 
       plot = first,
       units = "in", 
       width = 20,
       height= 9,
...
ggsave(filename = "/Users/islekbro/Desktop/genomize_makale/2_evidence_codes/evidence_outputs/1_plot_P_outputs/P_CF.pdf", 
       plot = second,
       units = "in", 
       width = 20,
       height= 9,
