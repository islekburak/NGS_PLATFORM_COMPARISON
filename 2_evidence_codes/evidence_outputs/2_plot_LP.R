...
data = read.csv("/Users/islekbro/Desktop/genomize_makale/2_evidence_codes/evidence_outputs/2_plot_LP_inputs/evidence_LP.csv", sep="\t" , header=TRUE)
...
library(ggplot2)
library(geomtextpath)
data = read.csv("/Users/islekbro/Desktop/genomize_makale/2_evidence_codes/evidence_outputs/2_plot_LP_inputs/common_LP.csv", sep="\t" , header=TRUE)
CS_data <- data %>%
  filter(platform=="CS_LP")

CF_data <- data %>%
  filter(platform=="CF_LP")
...
ggsave(filename = "/Users/islekbro/Desktop/genomize_makale/2_evidence_codes/evidence_outputs/2_plot_LP_outputs/LP_CS.pdf", 
       plot = first,
       units = "in", 
       width = 20,
       height= 9,
...
ggsave(filename = "/Users/islekbro/Desktop/genomize_makale/2_evidence_codes/evidence_outputs/2_plot_LP_outputs/LP_CF.pdf", 
       plot = second,
       units = "in", 
       width = 20,
       height= 9,
