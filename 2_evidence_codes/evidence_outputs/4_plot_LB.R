...
data = read.csv("/Users/islekbro/Desktop/genomize_makale/2_evidence_codes/evidence_outputs/4_plot_LB_inputs/evidence_LB.csv", sep="\t" , header=TRUE)
...
library(ggplot2)
library(geomtextpath)
data = read.csv("/Users/islekbro/Desktop/genomize_makale/2_evidence_codes/evidence_outputs/4_plot_LB_inputs/common_LB.csv", sep="\t" , header=TRUE)
CS_data <- data %>%
  filter(platform=="CS_LB")

CF_data <- data %>%
  filter(platform=="CF_LB")
...
ggsave(filename = "/Users/islekbro/Desktop/genomize_makale/2_evidence_codes/evidence_outputs/4_plot_LB_outputs/LB_CS.pdf", 
       plot = first,
       units = "in", 
       width = 20,
       height= 9,
...
ggsave(filename = "/Users/islekbro/Desktop/genomize_makale/2_evidence_codes/evidence_outputs/4_plot_LB_outputs/LB_CF.pdf", 
       plot = second,
       units = "in", 
       width = 20,
       height= 9,
