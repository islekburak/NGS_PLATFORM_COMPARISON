...
nodes = read.csv("/Users/islekbro/Desktop/poster/clingenVSseq2franklin/nodes.csv", sep=";" , header=TRUE)
links = read.csv("/Users/islekbro/Desktop/poster/clingenVSseq2franklin/links.csv", sep=";" , header=TRUE)
my_color <- 'd3.scaleOrdinal() .domain(["a","a1","a2","a3","a4","b","b1","b2","b3","b4","c","c1","c2","c3","c4"]) .range(["#ffb6a5","#ffd6cd","#b1cbe9","#cbefd8","#b1e1b4","#FF7959","#FFB3A3","#6FA0D7","#A0E1B6","#70C775","#ffb6a5","#ffd6cd","#b1cbe9","#cbefd8","#b1e1b4"])'
