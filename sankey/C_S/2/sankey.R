...
nodes = read.csv("/Users/islekbro/Desktop/poster/C_S/2/nodes.csv", sep=";" , header=TRUE)
links = read.csv("/Users/islekbro/Desktop/poster/C_S/2/links.csv", sep=";" , header=TRUE)
