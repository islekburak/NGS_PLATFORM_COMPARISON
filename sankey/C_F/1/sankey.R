...
nodes = read.csv("/Users/islekbro/Desktop/poster/clingen2franklin/nodes.csv", sep=";" , header=TRUE)
links = read.csv("/Users/islekbro/Desktop/poster/clingen2franklin/links.csv", sep=";" , header=TRUE)
